...
//
//       // ✅ บรรทัดแรก = plateNo, บรรทัดสอง = province
...
//   }
//
//   // ✅ จัดลำดับการอ่าน (บน→ล่าง, ซ้าย→ขวา)
//   List<Map<String, dynamic>> _sortDetectionsByReadingOrder(
//       List<Map<String, dynamic>> detections) {
//     if (detections.isEmpty) return detections;
//
//     const lineTolerance = 0.4; // ความคลาดเคลื่อนของ Y
//
...
//   }
//
//   // ✅ Extract เป็น List<String> ทีละบรรทัด
//   List<String> extractLinesFromDetections(List<Map<String, dynamic>> detections) {
...
//       if (det['label'] == '-') {
//         final bbox = det['bbox'] as List<int>;
//         final cropped = _cropImage(fullImage, bbox);
//
//         final tempPath =
...
//         );
//
//         log("OCR fallback: $ocrText");
//
//         final fixedLabel = ocrText.trim().isNotEmpty ? ocrText.trim() : '-';
//         det['label'] = fixedLabel;
//       }
//       updated.add(det);
//     }
//
